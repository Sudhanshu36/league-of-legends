...
<img src="figures/predict.png" alt="Prediction" style="width: 500px;"/>

## Activity on map

<p align="center"><img src="figures/events.png" alt="Summoner's Rift" style="width: 400px;"/></p>
<!--<p align="right">Questions?</p>-->
<p align="right">Questions? GitHub.com/<strong>VincentQB</strong></p>

<!-- 
## Questions?
<p align="center"><img src="figures/logo-github.png" alt="GitHub" style="width: 100px;"/> vincentqb</p>-->
<div>
  <img style="vertical-align:middle width:100px" src="figures/logo-github.png">
  <span style="">vincentqb</span>
</div>
-->
...
shinyUI(fluidPage(
fluidRow(
column(6, selectInput("eventTypeMap", NULL, 
                      c("All",
                        str_replace_all(unique(as.character(coord$eventType)), "_", " ")), 
                      selected = "CHAMPION KILL")),
column(4, selectInput("team", NULL, 
                      c("All", "BLUE WINS", "RED WINS"),
                      selected = "RED WINS"))
),
column(4, sliderInput("timeRange", label = "Time", 
                      min = 0, max = maxTime, value = c(0, 20))
),
fluidRow(
renderPlot({
