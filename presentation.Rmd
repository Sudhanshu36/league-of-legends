...
column(8, selectInput("eventTypeTime", NULL, 
                      c("All", unique(as.character(events$eventType))), 
                      selected = "ELITE_MONSTER_KILL"))
),
fluidRow(
renderPlot({
    ...
    if (input$eventTypeTime != "All") {
        data <- dplyr::filter(data, eventType == input$eventTypeTime)
    }
...
<img src="figures/scatter.png" alt="Experience vs Gold" style="width: 400px;"/>
-->