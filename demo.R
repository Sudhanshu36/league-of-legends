# https://gist.github.com/RyanHope/96665b0da636515917cc
...
getRIOT <- function(version, base, type=NULL, id=NULL, attr=NULL, params=NULL, region="na", static=TRUE, parse=TRUE, ...) {
  if (static)
    uri <- sprintf("https://prod.api.pvp.net/api/lol/static-data/%s", region)
  else
    uri <- sprintf("https://prod.api.pvp.net/api/lol/%s", region)
