...
p <- rocCurve.data %>%
  ...
  geom_point(color = gg_purple) +
  # geom_line(color = gg_purple) +
  geom_smooth(color = gg_purple, se = FALSE, alpha = 0.25) +
  geom_point(data = rocCurve.best, aes(x = 1-specificity, y = sensitivity), 
             color = gg_purple, size = 3) +
  xlab("False Positive Rate") +
  ylab("True Positive Rate") +
  geom_abline(intercept = 0, slope = 1, alpha = 0.5, color = gg_red)
