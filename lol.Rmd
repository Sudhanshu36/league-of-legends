...
permatch.events %>%
  ...
  # geom_bin2d(aes(color = ..count..), binwidth = 5, alpha = 0.5) +
  # stat_bin2d(binwidth = 5, alpha = 0.5) +
  xlab("Wards destroyed difference per min in first 20 min") +
  ylab("Wards placed difference per min in first 20 min")
```
...
ggplot(data, aes(WARD_KILL, WARD_PLACED, 
  ...
  # geom_bin2d(aes(color = ..count..), binwidth = 5, alpha = 0.5) +
  # stat_bin2d(binwidth = 5, alpha = 0.5) +
  xlab("Wards destroyed per min in first 20 min") +
  ylab("Wards placed per min in first 20 min")
```
...
ggplot(data, aes(CHAMPION_KILL, creepsPerMinDeltas, 
  ...
  # geom_bin2d(aes(color = ..count..), binwidth = 5, alpha = 0.5) +
  # stat_bin2d(binwidth = 5, alpha = 0.5) +
  xlab("Champion killed per min in first 20 min") +
  ylab("Creeps killed per min in first 20 min")
```
...
ggplot(training.misclassified, aes(CHAMPION_KILL, ELITE_MONSTER_KILL, 
  ...
  # geom_density2d(alpha = 1) +
  xlab("Champion killed per min in first 20 min") +
  ylab("Elite monster killed per min in first 20 min")
