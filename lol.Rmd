...
winGIVENherald <- Prob(team.probspace, event = winner == TRUE, given = firstRiftHerald == TRUE)
...
v <- venneuler(c(A = win, B = herald, "A&B" = winANDherald))
plot(v)

# library(VennDiagram)
# draw.pairwise.venn(1000,294,219)
# draw.pairwise.venn(win, herald, winANDherald)
```
