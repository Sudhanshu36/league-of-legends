...
first <- data.json %>% 
  ...
  spread_values(winner = jstring("winner")) %>%
  spread_values(firstBaron = jstring("firstBaron")) %>%
  spread_values(firstBlood = jstring("firstBlood")) %>%
  spread_values(firstDragon = jstring("firstDragon")) %>%
  spread_values(firstInhibitor = jstring("firstInhibitor")) %>%
  spread_values(firstRiftHerald = jstring("firstRiftHerald"))
```
