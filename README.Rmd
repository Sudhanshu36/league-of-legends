...
<img src="figures/world_championship_2015.jpg" alt="League of Legends" style="text-align: center; width: 600px;"/>
...
<img src="figures/game_example.jpg" alt="Gameplay" style="text-align: center; width: 600px;"/>
...
<img src="figures/map_20.png" alt="Summoner's Rift" style="text-align: center; width: 600px;"/>
...
<img src="figures/timeline.png" alt="Timeline" style="text-align: center; width: 600px;"/>
...
<img src="figures/conditional.png" alt="Conditional" style="text-align: center; width: 600px;"/>
...
<img src="figures/methods_acc_20.png" alt="Accuracy" style="text-align: center; width: 600px;"/>

The ROC curves also give an idea of the quality of the prediction. 

<img src="figures/methods_roc_20.png" alt="ROC" style="text-align: center; width: 600px;"/>

We can try to push the prediction window down to 10 minutes instead of 20 minutes as we have been analyzing. 

<img src="figures/methods_acc_10.png" alt="Accuracy" style="text-align: center; width: 600px;"/>

We can also look at the ROC curves in this case. 

<img src="figures/methods_roc_10.png" alt="ROC" style="text-align: center; width: 600px;"/>
...
<img src="figures/misclassified_20.png" alt="Misclassified" style="text-align: center; width: 600px;"/> 

<img src="figures/misclassified_10.png" alt="Misclassified" style="text-align: center; width: 600px;"/>
