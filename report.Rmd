...
A team usually manage to destroy the enemy's castle in about 33 &plusmn; 5 min. Only in long matches do champions reach their maximal levels, as it usually takes about 45 &plusmn; 3 min to happen. The timeline below shows the median time for the first of each event discussed.
...
<img src="figures/methods_acc_20.png" alt="Prediction" style="width: 500px;"/>
...
<img src="figures/methods_roc_20.png" alt="Prediction" style="width: 500px;"/>

We can try to push the prediction window down to 10 minutes. 

<img src="figures/methods_acc_10.png" alt="Prediction" style="width: 500px;"/>

We can also look at the ROC curves in this case. 

<img src="figures/methods_roc_10.png" alt="Prediction" style="width: 500px;"/>
