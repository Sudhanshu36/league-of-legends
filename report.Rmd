...
A team usually manage to destroy the enemy's castle in about 33 +/- 5 min. Only in long matches do champions reach their maximal levels, as it usually takes about 45 +/- 3 min to happen. The timeline below shows the median time for the first of each event discussed.
